...
public class SpeechService extends Service {
    ...
    public static final int GOOGLE_CREDENTIAL_NOT_AVAILABLE = -1;
    public static final String GOOGLE_CREDENTIAL = "google_credential";
    ...
    public IBinder onBind(Intent intent) {
        if(mCredentialResourceId == 0){
            mCredentialResourceId = intent.getIntExtra(SpeechService.GOOGLE_CREDENTIAL, SpeechService.GOOGLE_CREDENTIAL_NOT_AVAILABLE);
            fetchAccessToken();
        }
...
//                                .setLanguageCode(getDefaultLanguageCode())
    ...
    private class AccessTokenTask extends AsyncTask<Void, Void, AccessToken> {
        ...
        protected AccessToken doInBackground(Void... voids) {
            ...
            final InputStream stream = getResources().openRawResource(mCredentialResourceId);
            try {
